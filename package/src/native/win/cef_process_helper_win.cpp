...
public:
    ...
    virtual void OnContextCreated(CefRefPtr<CefBrowser> browser,
        ...
        window->SetValue("__thunderbunEventBridge", eventBridge, V8_PROPERTY_ATTRIBUTE_NONE);
        ...
        if (!is_sandboxed) {
            ...
            window->SetValue("__thunderbunBunBridge", bunBridge, V8_PROPERTY_ATTRIBUTE_NONE);
            ...
            window->SetValue("__thunderbunInternalBridge", internalBridge, V8_PROPERTY_ATTRIBUTE_NONE);
        }
