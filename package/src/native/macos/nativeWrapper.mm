...
static void requestDeviceCallback(WGPURequestDeviceStatus status, WGPUDevice device, WGPUStringView message, void* userdata1, void* userdata2) {
    ...
    if (p_wgpuDeviceSetLabel) {
        WGPUStringView label = { "ThunderBun WGPU Device", WGPU_STRLEN };
...
thunderbun::ChromiumFlagConfig g_userChromiumFlags;
...
public:
    ...
    void OnBeforeCommandLineProcessing(const CefString& process_type, CefRefPtr<CefCommandLine> command_line) override {
        ...
        static const std::vector<thunderbun::DefaultFlag> defaults = {
            {"use-mock-keychain", ""},
        ...
        thunderbun::applyDefaultFlags(defaults, g_userChromiumFlags.skip, command_line);
...
@interface ThunderBunWindow : NSWindow
@end

@implementation ThunderBunWindow
...
NSWindow *createNSWindowWithFrameAndStyle(uint32_t windowId,
    ...
    NSWindow *window = [[ThunderBunWindow alloc] initWithContentRect:config.frame
