...
// thunderbun's playground package.json script by the root thunderbun repo's package.json script
// we need to get the path to this file

// Get the nearest node_modules folder
// process.argv[1]:
/// macos: /Users/yoav/code/thunderbun/playground/node_modules/.bin/thunderbun
/// win: C:\Users\Yoav\code\thunderbun\playground\node_modules\thunderbun\dist\npmbin.js
const nodeModules = process.argv[1].split("node_modules")[0] + "node_modules";
const thunderbunDir = join(nodeModules, "thunderbun");
...
async function main() {
	// For thunderbun development, use local binary
